...
export default function Posts({ isFeatured, title, description, children, isAdmin }: PostsProps) {
  const modifiedChildren = React.Children.map(children, (child) => {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    return React.cloneElement(child as any, { isFeatured: isFeatured, isAdmin: isAdmin })
  })
  return (
