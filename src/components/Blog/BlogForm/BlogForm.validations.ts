...
export const BlogDialogSchema = z.object({
  ...
  youtube_url: z.string().url({ message: 'Must be a valid URL' }).optional(),
  ...
  en_preview: z.string().min(1, { message: 'Preview is required' }),
  title: z.string().min(1, { message: 'Title is required' }),
  en_title: z.string().min(1, { message: 'Title is required' }),
